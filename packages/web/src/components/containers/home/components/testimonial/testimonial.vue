<template>
<div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8 mb-32 sm:mb-56">
          ...
          <div class="relative mx-auto max-w-2xl lg:mx-0">
            ...
            <figure>
              <blockquote class="mt-6 text-lg font-semibold text-white sm:text-xl sm:leading-8">
                <p>“Thanks to the mock medical exams provided by this service, I was able to confidently prepare for my medical exams and achieve the scores I needed. The realistic testing conditions and expert feedback helped me identify my strengths and weaknesses, and develop a targeted study plan. The comprehensive coverage of essential topics and subtopics ensured I was fully prepared for every aspect of the exam. I highly recommend this service to any student preparing for their medical exams!”</p>
              </blockquote>
              <figcaption class="mt-6 text-base text-white">
                <div class="font-semibold">Zahra</div>
                <div class="mt-1">Medical Student</div>
              </figcaption>
            </figure>
          </div>
        </div>
