<template>
  <div class="bg-gray-900 py-24 sm:py-32 mb-24 sm:mb-32">
...
const stats = [
  {
    id: 1,
    name: 'Practice questions covering major medical subjects',
    value: '1,000+'
  },
  {
    id: 2,
    name: 'Improvement after using our platform (reported)',
    value: '25%'
  },
  {
    id: 3,
