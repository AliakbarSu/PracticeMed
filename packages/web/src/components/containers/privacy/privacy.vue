<template>
  <div class="bg-white px-6 py-32 lg:px-8">
    <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
      ...
      >
        Privacy Policy for Practice Med
      </h1>
      <div class="mt-10 max-w-2xl">
        ...
        <div class="mt-3 max-w-2xl pl-3">
          <ul role="list" class="mt-3 max-w-xl space-y-3 text-gray-600">
        ...
        <p class="mt-3">Examples of Cookies we use:</p>
        <div class="mt-3 max-w-2xl pl-3">
          <ul role="list" class="mt-3 max-w-xl space-y-3 text-gray-600">
            <li class="flex gap-x-3">
              <span
        ...
        <p class="mt-3">We use the collected data for various purposes:</p>
        <div class="mt-3 max-w-2xl pl-3">
          <ul role="list" class="mt-3 max-w-xl space-y-3 text-gray-600">
            <li class="flex gap-x-3">
        ...
        <div class="mt-3 max-w-2xl pl-3">
          <ul role="list" class="mt-3 max-w-xl space-y-3 text-gray-600">
            ...
            <li class="flex gap-x-3">
              <span
                >To protect and defend the rights or property of Practice
                Med</span
              >
            </li>
            <li class="flex gap-x-3">
